...
lista = [1,98,2,8,0,1,2,8,278,27,4,7,324,2,34,2,3,748,9,3,2,7,49,2,7,394,72374293749237492,3,7,494,9,4,8,47,74,2,64,7,3,6,7,426,84]
print(busqueda_inocente(lista,15))  
...
if __name__=='__main__':
    ...
    while len(conjunto_inicial) < tamaño:
        conjunto_inicial.add(random.randint(-3*tamaño, 3))
